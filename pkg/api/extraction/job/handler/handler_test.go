...
import (
	...
	"juno/pkg/api/extraction/job/policy"
	"juno/pkg/api/user"
	"net/http/httptest"
	"testing"
...
func (m *mockJobService) Create(userID, extractorID uuid.UUID) (*job.Job, error) {
...
func TestCreate(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		if res.Job.ExtractorID != req.ExtractorID {
			t.Errorf("Expected %s, got %s", req.ExtractorID, res.Job.ExtractorID)
		}
	})
}
