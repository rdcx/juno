...
import (
	...
	"juno/pkg/api/extraction/job/migration/mysql"
...
func TestCreate(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		err = db.QueryRow("SELECT id, user_id, extractor_id, status, created_at, updated_at FROM jobs WHERE id = ?", j.ID).Scan(&check.ID, &check.UserID, &check.ExtractorID, &check.Status, &check.CreatedAt, &check.UpdatedAt)
