...
[![license](https://img.shields.io/github/license/skx/monkey.svg)](https://juno/pkg/monkey/blob/master/LICENSE)
[![Release](https://img.shields.io/github/release/skx/monkey.svg)](https://juno/pkg/monkey/releases/latest)
...
Alternatively you could install a binary-release, from the [release page](https://juno/pkg/monkey/releases).
